...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" id="arrow-left-linear" viewBox="0 0 24 24">
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" id="arrow-right-linear" viewBox="0 0 24 24">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          <ul class="info d-flex flex-wrap list-unstyled m-0">
            <li class="location text-capitalize d-flex align-items-center me-4">
              <svg class="accent-color me-1" width="30" height="30">
        ...
        <div class="header-bottom offcanvas offcanvas-end" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
          ...
          <div class="offcanvas-body align-items-center justify-content-end">
            <ul class="navbar-nav mb-2 mb-lg-0">
              ...
              <li class="nav-item px-3">
                <a class="nav-link active p-0" href="contact.html">Contact</a>
              </li>
              <li class="nav-item px-3 dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                  ...
                  <li class="py-1"><a href="services.html" class="dropdown-item text-uppercase">Services <span
                        class="badge bg-secondary">Pro</span></a></li>
                  ...
                  <li class="py-1"><a href="faq.html" class="dropdown-item text-uppercase">FAQs <span
                        class="badge bg-secondary">Pro</span></a></li>
                  <li class="py-1"><a href="contact.html" class="dropdown-item active text-uppercase">Contact <span
                        class="badge bg-secondary">Pro</span></a></li>
                </ul>
              </li>
              <li class="nav-item px-3">
  ...
  <div class="section-title my-5 text-center">
    <p class="mb-2 fs-4 text-capitalize">Contact</p>
    <h3>Contact Us</h3>
  </div>
  ...
  <section id="contact-us" class="margin-medium text-center">
    <div class="container">
      <div class="any-questions">
        <h3 class="pb-3 mb-3">Have any question?</h3>
        <input type="text" name="name" placeholder="Full Name" class="w-100 mb-2 border p-3 ps-4 rounded-3">
        <input type="email" name="email" placeholder="Email" class="w-100 mb-2 border p-3 ps-4 rounded-3">
        <textarea class="w-100 mb-2 border p-3 ps-4 rounded-3" type="text" name="details" placeholder="Details"></textarea>
        <a href="#" class="btn btn-medium btn-primary btn-pill mt-3 text-uppercase">Submit</a>
      </div>            
    </div>
  </section>

  <section id="social" class="margin-medium text-center">
    <div class="container">
      <div class="social-info">
        <h3 class="pb-3">Social Info</h3>
        <p>These are our social links. If you want to get updated you can follow us.</p>
        <ul class="social-links mt-4 list-unstyled d-flex justify-content-center">
          <li>
            <a href="#">
              <svg class="facebook text-primary-500 me-4" width="40" height="40">
          ...
          <li>
            <a href="#">
              <svg class="twitter text-primary-500 me-4" width="40" height="40">
          ...
          <li>
            <a href="#">
              <svg class="instagram text-primary-500 me-4" width="40" height="40">
          ...
          <li>
            <a href="#">
              <svg class="linkein text-primary-500 me-4" width="40" height="40">
          ...
          <li>
            <a href="#">
              <svg class="youtube text-primary-500" width="40" height="40">
