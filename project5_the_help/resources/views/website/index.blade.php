...
<section id="slider">
    <div class="swiper slider position-relative">
      <div class="swiper-wrapper">
        <div class="swiper-slide d-flex" style="background-image: url('/assetts/images/slider-image.jpg'); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
          <div class="banner-content px-5 py-4 text-center m-auto py-5 rounded-4 shadow">
            <h2 class="mb-0">Best Cleaning Services</h2>
            <p class="fs-4 text-capitalize">Welcome to Super Clean Services, your one-stop solution for exceptional cleaning services!</p>
            <a href="services.html" class="btn btn-primary mt-3">Our Services</a>
          </div>
        </div>
        <div class="swiper-slide d-flex" style="background-image: url('/assetts/images/slider-image1.jpg'); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
          <div class="banner-content px-5 py-4 text-center m-auto py-5 rounded-4 shadow">
            <h2 class="mb-0">Best Window Cleaning</h2>
            <p class="fs-4 text-capitalize">Enjoy crystal-clear views with free window cleaning services. View our cleaning services now!</p>
            <a href="services.html" class="btn btn-primary mt-3">Our Services</a>
          </div>
        </div>
        <div class="swiper-slide d-flex" style="background-image: url('/assetts/images/slider-image.jpg'); background-size: cover; background-repeat: no-repeat; height: 80vh; background-position: center; height: 80vh;">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <img src="{{ asset('storage/' . $category->image) }}" class="card-img-top" alt="{{ $category->name }}"style="width: 100%; height: 50px; object-fit: contain;">
          <hr>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="call py-5 px-2">
              ...
              <p class="fs-4 text-capitalize text-light">Our energetic and helpful team are always ready for you.</p>
            </div>
          </div>
        </div>
...
<section id="our-services" class="padding-medium" style="background-image: url('/assetts/images/services-bg.png'); background-repeat: no-repeat; background-position: center;">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 mt-5">
          ...
          <p>Welcome to SuperClean Services, your trusted partner for top-tier cleaning solutions. With years of industry expertise, we are committed to delivering extra cleaning services that exceed your expectations. Our skilled and dedicated team takes pride in transforming spaces into immaculate havens, ensuring cleanliness and hygiene for homes and businesses alike.
            <br>
          <br>
          At SuperClean, we prioritize customer satisfaction and tailor our services to meet your specific needs. Using cutting-edge equipment and eco-friendly products, we leave no detail untouched, providing thorough and meticulous cleaning for every corner of your space.</p>
          <a class="btn btn-primary mt-4" href="about.html">Learn More</a>
        </div>
        
      </div>
    </div>
    <img class="pb-5 position-absolute d-none d-xxl-block end-0 bottom-0 w-auto" src="{{asset  ('assetts') }}/images/bg-pattern-img.png" alt="img">
</section>
...
<section id="pricing">
    <div class="container py-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="py-5 plan-post d-flex flex-column justify-content-between text-center border rounded-4 text-center my-4">
            <div class="plan-top">
        ...
        <div class="col-md-4">
          <div class="py-5 plan-post d-flex flex-column justify-content-between text-center border rounded-4 text-center">
            <div class="plan-top">
