        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <p class="card-text"><strong>Name:</strong> {{ $provider->name }}</p>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <p class="card-text"><strong>Phone:</strong> {{ $provider->phone }}</p>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('provider.provider.updateProfile') }}" method="POST">
                        ...
                        <!-- Email Field -->
                        <div class="row mb-3">
                            <label for="provider_email" class="col-md-4 col-form-label">Email</label>
                            <div class="col-md-8">
                            <!-- <p>Contacts</p> -->
                        ...
                        <div class="row mb-3">
                            ...
                            <!-- <p>Location</p> -->
                                <input type="text" class="form-control @error('location') is-invalid @enderror"
                                    id="location" name="location" value="{{ old('location', $provider->location) }}">
                                @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
