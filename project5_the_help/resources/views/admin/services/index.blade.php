        ...
        <table id="servicesTable" class="table table-hover table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <i class="fas fa-edit icon-btn" data-bs-toggle="modal" data-bs-target="#editServiceModal"
                            data-id="{{ $service->id }}" data-name="{{ $service->name }}"
                            data-description="{{ $service->description }}" data-duration="{{ $service->duration }}"
                            data-price="{{ $service->price }}" data-provider_id="{{ $service->provider_id }}"
                            data-status="{{ $service->status }}"></i>
                    </td>
                </tr>
                @endforeach
            </tbody>
            ...
            <form method="POST" action="{{ route('services.update') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control" id="editServiceDescription" name="description" rows="3"
                            required></textarea>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select" id="editServiceProvider" name="provider_id" required>
                            <option value="" disabled selected>Select Provider</option>
                            @foreach($providers as $provider)
                            <option value="{{ $provider->id }}">{{ $provider->name }}</option>
                            @endforeach
